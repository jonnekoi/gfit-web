...
const EditClientWorkoutModal = ({ workout, userId, closeModal }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-20 backdrop-blur-sm overflow-y-auto">
            <div
                ...
                <div className="flex flex-col space-y-5">
                    {isEditMode ? (
                        ...
                        <span className="text-2xl font-bold montserrat-text mb-4 bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">
                            {workout.day}
                        </span>
                    )
                    }
