                ...
                {isLoggedIn ? (
                    <>
                        <div className="space-x-5 text-orange-500">
                            <Link to="/"
                                  className="underline-hover text-white font-semibold bruno-ace-sc-regular text-1xl p-2">Home</Link>
                            <Link to="/customers"
                                  className="underline-hover text-white font-semibold bruno-ace-sc-regular text-1xl p-2">Customers</Link>
                            <Link to="/workouts"
                    ...
                    <div className="space-x-7">
                        <Link to="/login" className="text-white bruno-ace-sc-regular text-xl">Login</Link>
                        <Link to="/register" className="text-white bruno-ace-sc-regular text-xl">Register</Link>
                    </div>
                )}
            </header>
