...
const SelectedWorkoutModal = ({
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-20 backdrop-blur-sm overflow-y-auto p-4 z-50">
            <div className="bg-gray-900/90 text-white p-4 md:p-6 rounded-xl w-full max-w-6xl shadow-2xl border border-orange-500/30 flex flex-col max-h-[90vh] overflow-hidden">
                <div className="text-center mb-4 md:mb-6">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 text-gray-300">
                        <p className="montserrat-text font-medium text-sm md:text-base">
                            <span className="text-orange-300">Crafted</span> {formatDate(selectedWorkout.workout_created_at)}
                        </p>
                                ...
                                {isReadOnly ? (
                                    <div className="grid grid-cols-3 gap-2 text-sm">
                                        <div className="flex flex-col items-center">
                                            <span className="text-gray-400 mb-1">Reps</span>
                                            <span className="px-2 py-1 bg-blue-500/10 rounded text-blue-300">
                                                {exercise.low_reps} - {exercise.max_reps}
                                            </span>
                                        </div>
                                        <div className="flex flex-col items-center">
                                            <span className="text-gray-400 mb-1">Sets</span>
                                            <span className="px-2 py-1 bg-green-500/10 rounded text-green-300">
                                                {exercise.sets}
                                            </span>
                                        </div>
                                        <div className="flex flex-col items-center">
                                            <span className="text-gray-400 mb-1">Weight</span>
                                            <span className="px-2 py-1 bg-purple-500/10 rounded text-purple-300">
                                                {exercise.weight} kg
                                            </span>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        <div>
                                            <label className="block text-gray-400 text-xs mb-1">Reps Low</label>
                                            <input
                                                type="number"
                                                value={exercise.low_reps}
                                        ...
                                        <div>
                                            <label className="block text-gray-400 text-xs mb-1">Reps Max</label>
                                            <input
                                                type="number"
                                                value={exercise.max_reps}
                                        ...
                                        <div>
                                            <label className="block text-gray-400 text-xs mb-1">Sets</label>
                                            <input
                                                type="number"
                                                value={exercise.sets}
                ...
                <div className="flex flex-col sm:flex-row justify-center mt-4 md:mt-6 gap-2 md:gap-4">
                    <button
